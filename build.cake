...
Setup<BuildParameters>(context =>
{
    var parameters = new BuildParameters(context)
                        .ForSolution("./src/Cake.SonarScanner.sln")
                        .ForSonarQubeProject("Cake.SonarScanner")
                        .WithNuGetPackageProject("./src/Cake.SonarScanner/Cake.SonarScanner.csproj");;
    ...
    Information("Building version {0} of Cake.SonarScanner ({1}, {2}) using version {3} of Cake.",
